...
register #(.WIDTH(32)) reg_dataB_MEM
(
    .clk    (i_clk              ),
    .rstn   (i_rst_n            ),
    .en     (1'b1               ),
...
register #(.WIDTH(32)) reg_pc_plus4_MEM
(
    .clk    (i_clk              ),
    .rstn   (i_rst_n            ),
    .en     (1'b1               ),
...
register #(.WIDTH(1)) reg_reg_write_MEM
(
    .clk    (i_clk              ),
    .rstn   (i_rst_n            ),
    .en     (1'b1               ),
...
register #(.WIDTH(1)) reg_mem_write_MEM
(
    .clk    (i_clk              ),
    .rstn   (i_rst_n            ),
    .en     (1'b1               ),
...
register #(.WIDTH(2)) reg_result_src_MEM
(
    .clk    (i_clk              ),
    .rstn   (i_rst_n            ),
    .en     (1'b1               ),
